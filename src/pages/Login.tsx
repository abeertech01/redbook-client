...
import { signupUser } from "../app/thunks/auth"
import { SIGNUP_USER_PAYLOAD } from "../utils/types"
    ...
    <div className="h-screen flex flex-col justify-center items-center">
      {isLogin ? (
        <div className="w-[276px] flex flex-col gap-y-4 justify-between">
          ...
          <button className="btn btn-success text-lg">Login</button>
          <div>
        ...
        <div className="w-[276px] flex flex-col gap-y-4 justify-between">
          ...
          >
            ...
            <button className="btn btn-success text-lg">Sign up</button>
          </form>
          <div>
